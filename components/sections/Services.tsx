    ...
    return (
        <section id="services" className="py-20">
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-serif text-white mb-4 drop-shadow-sm">Servicios</h2>
                    <div className="h-1 w-20 bg-white mx-auto opacity-20 rounded-full"></div>
                </motion.div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {services.map((s, i) => (
                        ...
                        >
                            <div className="w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-white/20 group-hover:scale-110 transition-transform">
                                {s.icon}
                            </div>
                            <h3 className="text-2xl font-serif text-white mb-3">{s.title}</h3>
                            <p className="text-gray-300 leading-relaxed text-sm font-medium">{s.description}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
